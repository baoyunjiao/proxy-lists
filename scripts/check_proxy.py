...
TEST_APIS_SOCKS4 = [
    ("3.232.78.107", 80, "/ip", False),  # HTTP + IPv4
    ("54.236.169.179", 80, "/ip", False),
    ("44.195.71.76", 80, "/ip", False),
    ("35.174.219.145", 80, "/ip", False),
    ("52.202.125.113", 80, "/ip", False),
    ("52.200.102.227", 80, "/ip", False),
]
